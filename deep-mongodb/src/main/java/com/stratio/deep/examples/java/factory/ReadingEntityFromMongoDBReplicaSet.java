...
public final class ReadingEntityFromMongoDBReplicaSet {
    private static final Logger LOG = Logger
            .getLogger(ReadingEntityFromMongoDBReplicaSet.class);
    ...
    public static void doMain(String[] args) {
        ...
        MongoDeepJobConfig inputConfigEntity = MongoConfigFactory.createMongoDB(MessageEntity.class).host(host1)
