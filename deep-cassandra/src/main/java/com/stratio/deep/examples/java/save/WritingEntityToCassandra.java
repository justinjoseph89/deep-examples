...
import com.stratio.deep.examples.java.entities.DomainEntity;
import com.stratio.deep.examples.java.entities.PageEntity;
    ...
    public static void doMain(String[] args) {
        ...
        JavaPairRDD<String, PageEntity> pairRDD = inputRDD.mapToPair(new PairFunction<PageEntity, String,
            ...
            public Tuple2<String, PageEntity> call(PageEntity e) {
                return new Tuple2<>(e.getDomainName(), e);
            }
        });
